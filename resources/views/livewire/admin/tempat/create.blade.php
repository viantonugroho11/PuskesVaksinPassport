             ...
             <form wire:submit.prevent="store">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" wire:model="nama" class="form-control @error('nama') is-invalid @enderror" id="exampleInputEmail1" placeholder="Input Nama Tempat">
                    @error('nama')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" wire:model="link" class="form-control @error('link') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter email">
                    @error('link')
                        <span class="invalid-feedback">
                                {{ $message }}
                         </span>
